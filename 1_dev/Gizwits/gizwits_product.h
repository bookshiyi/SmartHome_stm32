...
#define UART_TxPin             GPIO_Pin_10
    ...
    void my_humi_handler(void);
    void my_heater_handler(void);
    void my_temp_handler(void);  
    void my_dht11_handler(void);//温湿度传感器处理函数
    void my_ir_handler(void);//人体红外处理函数
		void my_oled_hadler(void);//oled显示程序
