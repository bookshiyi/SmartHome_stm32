...
* @{
*/
#define PRODUCT_KEY "9d0e1e8439bf4c95b2a28caf565fa641"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "073e426b34f14878852f4bf42a1b16f8"
...
* @{
*/
#define relay_4_BYTEOFFSET                    0
#define relay_4_BITOFFSET                     0
#define relay_4_LEN                           1
#define relay_1_BYTEOFFSET                    0
#define relay_1_BITOFFSET                     1
#define relay_1_LEN                           1
#define relay_2_BYTEOFFSET                    0
#define relay_2_BITOFFSET                     2
#define relay_2_LEN                           1
#define buzz_BYTEOFFSET                    0
#define buzz_BITOFFSET                     3
#define buzz_LEN                           1
#define relay_3_BYTEOFFSET                    0
#define relay_3_BITOFFSET                     4
#define relay_3_LEN                           1
#define mode_auto_manu_BYTEOFFSET                    0
#define mode_auto_manu_BITOFFSET                     5
#define mode_auto_manu_LEN                           1
#define mode_winter_summer_BYTEOFFSET                    0
#define mode_winter_summer_BITOFFSET                     6
#define mode_winter_summer_LEN                           1
#define mode_safe_BYTEOFFSET                    0
#define mode_safe_BITOFFSET                     7
#define mode_safe_LEN                           1
#define ir_BYTEOFFSET                    6
#define ir_BITOFFSET                     0
#define ir_LEN                           1

#define temp_upper_RATIO                         1
#define temp_upper_ADDITION                      0
#define temp_upper_MIN                           0
#define temp_upper_MAX                           80
#define temp_lower_RATIO                         1
#define temp_lower_ADDITION                      0
#define temp_lower_MIN                           0
#define temp_lower_MAX                           80
#define humi_threshold_RATIO                         1
#define humi_threshold_ADDITION                      0
#define humi_threshold_MIN                           10
#define humi_threshold_MAX                           90
#define heater_hour_RATIO                         1
#define heater_hour_ADDITION                      0
#define heater_hour_MIN                           0
#define heater_hour_MAX                           23
#define heater_min_RATIO                         1
#define heater_min_ADDITION                      0
#define heater_min_MIN                           0
#define heater_min_MAX                           59
#define temp_RATIO                         1
...
typedef enum
{
  ...
  EVENT_buzz,
  EVENT_relay_3,
  EVENT_mode_auto_manu,
  EVENT_mode_winter_summer,
  EVENT_mode_safe,
  EVENT_temp_upper,
  EVENT_temp_lower,
  EVENT_humi_threshold,
  EVENT_heater_hour,
  EVENT_heater_min,
...
typedef struct {
  ...
  bool valuebuzz;
  bool valuerelay_3;
  bool valuemode_auto_manu;
  bool valuemode_winter_summer;
  bool valuemode_safe;
  uint32_t valuetemp_upper;
  uint32_t valuetemp_lower;
  uint32_t valuehumi_threshold;
  uint32_t valueheater_hour;
  uint32_t valueheater_min;
  bool valueir;
  uint32_t valuetemp;
  uint32_t valuerh;
} dataPoint_t;
...
typedef struct {
  uint8_t flagrelay_4:1;
  uint8_t flagrelay_1:1;
  uint8_t flagrelay_2:1;
  uint8_t flagbuzz:1;
  uint8_t flagrelay_3:1;
  uint8_t flagmode_auto_manu:1;
  uint8_t flagmode_winter_summer:1;
  uint8_t flagmode_safe:1;
  uint8_t flagtemp_upper:1;
  uint8_t flagtemp_lower:1;
  uint8_t flaghumi_threshold:1;
  uint8_t flagheater_hour:1;
  uint8_t flagheater_min:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valuetemp_upper;
  uint8_t valuetemp_lower;
  uint8_t valuehumi_threshold;
  uint8_t valueheater_hour;
  uint8_t valueheater_min;
} attrVals_t;
